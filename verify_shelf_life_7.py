...
async def main():
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.wait_for_selector("h1:has-text('Brüggen Innovation Catalogue')", timeout=10000)
            ...
            # Use a dummy file since the backend will return dummy data anyway
            ...
            await page.wait_for_selector("#recipe-carousel .carousel-item", timeout=30000)
            ...
            await page.wait_for_selector(".alert-success:has-text('Your new recipe has been successfully published')", timeout=15000)
